...
def evaluate_full_batch(model, minibatch, mode='val'):
    ...
    #np.savetxt("C:/Users/xs/Desktop/图采样有向图代码/test data/分类散点图数据/MDA-GCNGS/二分类/label[702].txt", node_target1 ,fmt='%s', newline='\n')
...
if __name__ == '__main__':
    ...
    #np.savetxt("C:/Users/xs/Desktop/图采样有向图代码/test data/分类散点图数据/MDA-GCNGS/二分类/label[702]1.txt", ys_test[0] ,fmt='%s', newline='\n')
